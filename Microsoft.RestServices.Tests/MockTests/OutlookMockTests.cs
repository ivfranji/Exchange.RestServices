namespace Microsoft.RestServices.Tests.MockTests
{
    using System;
    ...
    public class OutlookMockTests : OutlookMockTestsBase
    {
        ...
        public void Test_FindTaskItemsWithWellKnownFolderName()
        {
            this.RunHttp200WithEmptyResponseBetaEndpoint(
                (exchangeService) =>
                {
                    exchangeService.FindItems(WellKnownFolderName.Tasks, new TaskView(10));
                },
                (httpRequestMessage) =>
                {
                    Assert.AreEqual(
        ...
        public void Test_FindContactItemsWithWellknownFolderName()
        {
            this.RunHttp200WithEmptyResponseBetaEndpoint(
                (exchangeService) =>
                {
                    exchangeService.FindItems(WellKnownFolderName.Contacts, new ContactView(10));
                },
                (httpRequestMessage) =>
                {
                    Assert.AreEqual(
        ...
        public void Test_ForwardMailFromMessageInstanceThrowsOnNullRecipient()
        {
            ...
            {
                exchangeService.ForwardEmail(msg, parameters);
            });
        }
